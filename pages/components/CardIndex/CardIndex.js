...
export default function CardIndex() {
  const data = [
    ...
    },
    {
      title: 'Pacientes',
      description:
        'Aca encontramos unlistado con todos los pacientes, tambien podemos crear y actualizar un paciente.',
    ...
    },
    {
      title: 'Productos',
      description:
        'Aca encontramos un listado de todos los productos, con sus cantidades, tambien podemos crear productos',
    ...
    },
    {
      title: 'Contabilidad',
      description:
        'Aca encontramos un listado de todos los pacientes con informacion de abonos',
