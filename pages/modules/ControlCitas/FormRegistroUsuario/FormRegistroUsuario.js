...
export default function FormRegistroUsuario({ setOpen, setOpenRegCita, setCedulaPaciente, cedulaPaciente, accion }) {
  ...
  const onSubmit = (data) => (post(url, data, setDataResponse), console.log(data), setCedulaPaciente(data.cedula));
