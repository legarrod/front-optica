...
export default function ResumenHistoria({ setVerHistoria }) {
  ...
  const getCitas = async (
    urlObtenercitasporpaciente,
    setDataCitaPaciente = null
  ) => {
    try {
  ...
  const handlerItemSearch = () => {
    getCitas(
      `${urlObtenercitasporpaciente}${cedulaPaciente}`,
      setDataCitaPaciente
    );
  };
  return (
      ...
      <div className="overflow-auto w-11/12 h-full bg-white p-5 flex flex-wrap rounded-xl">
        <div>
          <div className="flex flex-wrap">
            <input
              className="bg-white h-10 rounded-lg border-gray-800 border-2 my-0 "
          ...
          <div>
            {dataCitaPaciente &&
              dataCitaPaciente.map((item, index) => (
                <div className="flex flex-row mt-2">
                  <p key={index} className="mr-2">
                    {item.fecha_cita}
                  </p>
                  <VisibilityIcon onClick={() => handlerViewCita(item)} />
                </div>
              ))}
          </div>
        </div>
        ...
        {viewCita && (
          <div className="ml-5 w-3/5 border-2 p-5 rounded-lg">
            <div className="flex flex-row">
              <div>
                ...
                <p className="text-sm text-gray-700 my-1">
                  {citaPaciente.celular}
                </p>
                <p className="text-sm text-gray-700 my-1">
                  {citaPaciente.ocupacion}
                </p>
                <p className="text-sm text-gray-700 my-1">
                  {citaPaciente.direccion}
                </p>
              </div>
              <div>
                <textarea
                  className="border-b-4 ml-4 border-2 w-full border-gray-400 rounded-md mb-3 px-2 h-20 shadow-lg"
                  name="note"
            ...
            <div className="flex flex-wrap justify-center items-center">
              <div className="flex flex-col justify-center w-2/5 mx-1 my-1 border bottom-2 border-blue-500 rounded-lg p-1 items-start">
                ...
                <div className="flex flex-row m-1 ">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.lejos_esferico_derecho}
                  </p>
                </div>
                <div className="flex flex-row m-1 justify-center items-center">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.lejos_esferico_izquierdo}
                  </p>
                </div>
                <div className="flex flex-row m-1 justify-center items-center">
                  <p className="text-xs font-semibold mr-2">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.cerca_esferico_derecho}
                  </p>
                </div>
                <div className="flex flex-row m-1 justify-center items-center">
                  <p className="text-xs font-semibold mr-2">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.cerca_esferico_izquierdo}
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center w-2/5 mx-1 my-1 border bottom-2 border-blue-500 rounded-lg p-1 items-start">
                ...
                <div className="flex flex-row m-1 justify-center items-center">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.lejos_cilindro_derecho}
                  </p>
                </div>
                <div className="flex flex-row m-1 justify-center items-center">
                  <p className="text-xs font-semibold mr-2">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.lejos_cilindro_izquierdo}
                  </p>
                </div>
                <div className="flex flex-row m-1 justify-center items-center">
                  <p className="text-xs font-semibold mr-2">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.cerca_cilindro_derecho}
                  </p>
                </div>
                <div className="flex flex-row m-1 justify-center items-center">
                  <p className="text-xs font-semibold mr-2">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.cerca_cilindro_izquierdo}
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center w-2/5 mx-1 my-1 border bottom-2 border-blue-500 rounded-lg p-1 items-start">
                ...
                <div className="flex flex-row m-1 justify-center items-center">
                  ...
                  <p className="text-xs ">
                    {citaPaciente.ccerca_add_izquierdo}
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center w-2/5 mx-1 my-1 border bottom-2 border-blue-500 rounded-lg p-1 items-start">
